			...
			<form className="max-w-sm mx-auto" action={formAction}>
				...
				<div className="mb-5">
					...
					<input
						...
						id="email"
						name="email"
						className=" text-sm rounded-lg block w-full p-2.5 border-gray-600  focus:ring-blue-500 focus:border-blue-500"
				...
				<div className="mb-5">
					...
					<input
						...
						id="password"
						name="password"
						className="text-sm rounded-lg block w-full p-2.5  focus:ring-blue-500 focus:border-blue-500"
						required
					/>
				</div>
